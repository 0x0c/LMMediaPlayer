...
Pod::Spec.new do |s|
  ...
  s.source_files = 'Pod/Classes/Category/NSArray+LMMediaPlayerShuffle/*.{h,m}', 'Pod/Classes/MediaPlayerView/*.{h,m}', 'Pod/Classes/MediaPlayer/LMMediaItem/*.{h,m}', 'Pod/Classes/MediaPlayer/LMMediaItemQueueManager/*.{h,m}', 'Pod/Classes/MediaPlayer/LMMediaPlayer/*.{h,m}, Pod/Classes/Helper/*.{h,m}'
  s.resource_bundles = {
